...
var redirect_android = decodeURIComponent(android_af_dp+is_q_and+other_param_app+external_source+af_utm_source+af_utm_medium+af_utm_campaign+af_utm_content_plus+af_ga_uid_sm);
var redirect_iphone = decodeURIComponent(ios_af_dp+is_q_ios+external_source+af_utm_source+af_utm_medium+af_utm_campaign+af_utm_content_plus+af_ga_uid_sm);
var redirect_unknown = decodeURIComponent(web_link+other_param_web+utm_all);
...
if (platform=="android") {
    setTimeout(function(){window.location.href = redirect_android},2100)
    setTimeout(function(){window.location.href = redirect_unknown},2150)
} else if (platform=="iPhone") {
    setTimeout(function(){window.location.href = redirect_iphone},2100)
    setTimeout(function(){window.location.href = redirect_unknown},2150)
} else {
