...
var af_utm_adset = ''; var af_utm_channel = ''; var af_utm_ad = '';

var af_utm_adset = utm_source_sm ? '&af_adset='+utm_source_sm : '';
var af_utm_channel = utm_medium_sm ? '&af_channel='+utm_medium_sm : '';
var af_utm_ad = utm_campaign_sm ? '&af_ad='+utm_campaign_sm : '';
...
// iOS
var redirect_iphone = 'https://sberbankonline.onelink.me/46WQ/smartlink'+'?'+'af_force_deeplink=true'+af_c+af_utm_adset+af_utm_channel+af_utm_ad+'&is_retargeting=true'+'&af_dp='+ios_af_dp+is_q_ios+other_param_app+external_source+af_utm_source+af_utm_medium+af_utm_campaign+af_utm_content_plus+af_ga_uid_sm+af_ios_url;
